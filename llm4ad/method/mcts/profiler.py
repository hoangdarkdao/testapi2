...
class MCTSProfiler(ProfilerBase):
...
class MATensorboardProfiler(TensorboardProfiler, MCTSProfiler):
...
class MAWandbProfiler(WandBProfiler, MCTSProfiler):
